...
#      provider = google-beta
#      project = "fourth-walker-437420-f1"
...
# #   }
# #   enabled = true
# #   notification_channels = ["projects/fourth-walker-437420-f1/notificationChannels/16399540197443471345"]
# # }
...
#     ExecStart=/usr/bin/docker run --rm --name=gcpfuse-mounter --privileged --log-driver=gcplogs --log-opt gcp-project=${var.project_id} --volume /dev/fuse:/dev/fuse --volume /mnt/disks/sftpgo:/mnt/sftpgo:shared  northamerica-northeast1-docker.pkg.dev/fourth-walker-437420-f1/gcp-repo/gcs-bucket-mount:latest
...
#   service_account {
#     email  = "sftpgo-sa@fourth-walker-437420-f1.iam.gserviceaccount.com"
...
#   #subnetwork = "projects/fourth-walker-437420-f1/regions/northamerica-northeast1/subnetworks/default"
#   region = var.region
# }
...
# #         containers:
# #           - name: gcs-fuse
# #             image:  northamerica-northeast1-docker.pkg.dev/fourth-walker-437420-f1/gcp-repo/gcs-bucket-mount
# #             securityContext:
# #               privileged: true
# #             volumeMounts:
# #             - name: dev-fuse
